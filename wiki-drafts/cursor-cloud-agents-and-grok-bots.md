...
formerly called Background Agents. docs: [Cloud Agents](https://cursor.com/docs/cloud-agent.md).
...
steward’s honesty pin still holds: **shared box ≠ security boundary**. cloud agents are *more* isolated (own VM), but they still get whatever secrets and network you give them. humans merge PRs.
