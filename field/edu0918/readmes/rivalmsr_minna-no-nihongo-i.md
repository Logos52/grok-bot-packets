...
│   └── lesson-22.md       <- 第22課: 名詞修飾 (modifikasi kata benda) — [klausa 普通形] + 名詞, subjek が
├── reference/
...
| [第22課 (Lesson 22)](lessons/lesson-22.md) | Modifikasi kata benda (名詞修飾) | [klausa 普通形] + 名詞 (い直接／な+な／N+の／V全時制・ている・たい・てもいい…), subjek anak kalimat が, 4 peran (deskripsi/topik/subjek/objek + が objek), 言葉 memakai かぶる/きる/はく/かける/する/つける | 言葉 ✅ · 練習A ✅ · 練習B ✅ |
